...
function assignSuitImage(elementToAssign, cardSuit){
	switch(cardSuit){
		case "Hearts":
			document.getElementById(elementToAssign).src = "assets/heart.png";
		break;

		case "Spades":
			document.getElementById(elementToAssign).src = "assets/spade.png";
		break;

		case "Diamonds":
			document.getElementById(elementToAssign).src = "assets/diamond.png";
		break;

		case "Clubs":
			document.getElementById(elementToAssign).src = "assets/club.png";
		break;
...
function deal(){
	...
	document.getElementById('dealerCenter2').src = "assets/octopus1.png";
